...
@XmlRootElement
@XmlType(propOrder = {"id", "codeValue", "uri", "url", "prefLabel", "definition", "description", "changeNote", "startDate", "endDate", "modified", "status", "version", "source", "legalBase", "governancePolicy", "dataClassifications", "externalReferences"})
