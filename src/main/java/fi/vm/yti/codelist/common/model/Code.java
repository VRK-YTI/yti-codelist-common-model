...
@Table(name = "code")
@XmlRootElement
@XmlType(propOrder = {"codeValue", "uri", "url", "id", "status", "hierarchyLevel", "startDate", "endDate", "modified", "prefLabel", "description", "definition", "codeScheme", "shortName", "externalReferences", "broaderCodeId"})
