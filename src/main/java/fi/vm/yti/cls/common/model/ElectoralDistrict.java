...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "code", scope = ElectoralDistrict.class)
@Proxy(lazy = false)
@XmlRootElement
...
public class ElectoralDistrict extends AbstractCommonCode implements Serializable {
