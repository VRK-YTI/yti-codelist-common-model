...
public class ApiConstants {
    ...
    public static final String CONTENT_HEADER_PREFLABEL_FI = "PREFLABEL_FI";
    public static final String CONTENT_HEADER_PREFLABEL_SV = "PREFLABEL_SV";
    public static final String CONTENT_HEADER_PREFLABEL_EN = "PREFLABEL_EN";
    public static final String CONTENT_HEADER_DEFINITION_PREFIX = "DEFINITION_";
    public static final String CONTENT_HEADER_DEFINITION_FI = "DEFINITION_FI";
    public static final String CONTENT_HEADER_DEFINITION_SV = "DEFINITION_SV";
    public static final String CONTENT_HEADER_DEFINITION_EN = "DEFINITION_EN";
    public static final String CONTENT_HEADER_DESCRIPTION_PREFIX = "DESCRIPTION_";
    public static final String CONTENT_HEADER_DESCRIPTION_FI = "DESCRIPTION_FI";
    public static final String CONTENT_HEADER_DESCRIPTION_SV = "DESCRIPTION_SV";
    public static final String CONTENT_HEADER_DESCRIPTION_EN = "DESCRIPTION_EN";
    public static final String CONTENT_HEADER_CHANGENOTE_PREFIX = "CHANGENOTE_";
    public static final String CONTENT_HEADER_CHANGENOTE_FI = "CHANGENOTE_FI";
    public static final String CONTENT_HEADER_CHANGENOTE_SV = "CHANGENOTE_SV";
    public static final String CONTENT_HEADER_CHANGENOTE_EN = "CHANGENOTE_EN";
